  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="relative bg-gradient-to-b from-muted/50 to-background pt-[96px] lg:pt-[104px]">
        <div className="max-w-[1500px] mx-auto px-2 sm:px-6 lg:px-10 py-12 lg:py-16">
      ...
      <div className="max-w-[1000px] mx-auto px-2 sm:px-6 lg:px-10 py-8 lg:py-12">
            ...
            <div className="px-6 py-6">
              ...
              {trackingResult.order.pricing && (
                <div className="mt-4 pt-4 border-t border-border text-right">
                  <span className="text-lg font-bold">Total: ₹{trackingResult.order.pricing.total?.toLocaleString('en-IN')}</span>
                </div>
              )}
            </div>
