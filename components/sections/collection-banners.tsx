            ...
            <div className="max-w-5xl space-y-10">
              ...
              <div className="overflow-hidden">
                <h2 className="animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
                  <span className="block font-serif font-[300] text-3xl md:text-7xl lg:text-9xl text-white tracking-[0.4em] leading-none uppercase drop-shadow-xl translate-y-0 group-hover:-translate-y-2 transition-transform duration-1000">
              ...
              <div className="flex items-center justify-center gap-6 animate-in fade-in duration-1000 delay-500">
                ...
                <span className="text-xs md:text-lg font-bold tracking-[0.5em] text-white/80 uppercase">
                  {festiveData?.offer || "CELEBRATE IN STYLE"}
                </span>
                <div className="w-8 md:w-16 h-px bg-white/30" />
              </div>

              <p className="text-white/80 text-sm md:text-lg lg:text-xl max-w-2xl mx-auto font-light leading-relaxed tracking-widest drop-shadow-md animate-in fade-in duration-1000 delay-700">
              ...
              <div className="pt-4 animate-in fade-in duration-1000 delay-1000">
                <div className="inline-flex items-center border border-white/40 text-white px-10 py-4 rounded-full font-bold text-xs md:text-lg tracking-[0.2em] hover:bg-white hover:text-black transition-all duration-500 hover:px-14 uppercase">
