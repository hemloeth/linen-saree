    ...
    <div className={cn("group", className)}>
      <div className="relative aspect-[3/4] overflow-hidden bg-muted mb-4">
        ...
        <div className="absolute top-3 left-3 flex flex-col gap-2">
          ...
          {product.isNew && (
            <span className="bg-foreground text-background text-xs px-2 py-1 font-medium">
              NEW
            </span>
          )}
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
          <button
            ...
            className="w-full bg-background/95 hover:bg-background py-3 px-4 flex items-center justify-center gap-2 text-sm font-medium transition-colors"
          >
