              ...
              <div className="max-w-4xl px-4 md:px-8">
                <div className="mb-6 md:mb-8">
                  <h2 className="banner-text-shadow">
                    <span className="block text-2xl md:text-5xl lg:text-6xl font-script mb-2 md:mb-4 text-white">festive</span>
                    <span className="block text-3xl md:text-6xl lg:text-8xl font-bold tracking-wider text-white">COLLECTION</span>
                  </h2>
                </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center text-center">
              <div className="max-w-4xl px-4 md:px-8">
                <div className="mb-6 md:mb-8">
                  <h2 className="banner-text-shadow">
                    <span className="block text-2xl md:text-5xl lg:text-6xl font-script mb-2 md:mb-4 text-white">festive</span>
                    <span className="block text-3xl md:text-6xl lg:text-8xl font-bold tracking-wider text-white">BIG SALE</span>
                  </h2>
                </div>
